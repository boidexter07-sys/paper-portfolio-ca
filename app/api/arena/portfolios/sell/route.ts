// POST /api/arena/portfolios/sell — sell a stock inside a challenge
...
import { sellStock, getChallengePortfolio } from '@/lib/arena/portfolios';
...
export async function POST(req: NextRequest) {
  ...
  const result = sellStock({ portfolioId, ticker: ticker.toUpperCase(), quantity });
