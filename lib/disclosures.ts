// Paper Portfolio Canada — Regulatory disclosures.
...
export const FOOTER_DISCLOSURE = {
  long: 'Paper Portfolio Canada is an educational tool. Nothing here is investment advice. All trades are paper trades. We do not connect to any real brokerage. See the in-app Privacy notice for how data is handled.',
  short: 'Educational tool. Not investment advice. All trades are paper trades.',
};

export const TRIAL_DISCLOSURE = {
  long: 'Your 7-day free trial gives you full access to every Paper Portfolio Canada feature. After the trial, you can subscribe to keep your paper portfolio. We will never charge you automatically during the trial. Cancel anytime.',
  short: '7-day free trial. No automatic charges. Cancel anytime.',
};

export const SIGNUP_DISCLOSURE = {
  long: 'By creating an account you confirm you are 18 or older and live in Canada. Paper Portfolio Canada is an educational tool. Nothing here is investment advice. We will not connect to any real brokerage on your behalf.',
...
export const AGE_GATE_BODY = {
  long: 'Paper Portfolio Canada is built for adults. We ask for your age so we can keep the experience appropriate and meet our legal duties. We do not collect any government ID.',
  short: 'Paper Portfolio Canada is for adults 18 and over.',
};

export const PIPEDA_NOTICE = {
  long: 'We collect the minimum needed to run Paper Portfolio Canada: your email, your investing style preference, your paper portfolio, and your watchlist. We never collect real brokerage credentials, real trade history, or government ID. Data lives in a local database for this prototype. You can delete your account and all your data at any time from Account settings.',
  short: 'We collect the minimum needed to learn. You can delete everything anytime.',
};

export const NO_ADVICE_DISCLAIMER = {
  long: 'Paper Portfolio Canada is a learning tool, not a financial advisor. Articles and explainers in the Learning Hub are educational. They are not a recommendation to buy or sell any security. Talk to a registered advisor before making real investment decisions.',
  short: 'Educational only. Not financial advice.',
};

// Plain-only safety copy for paper-trading touch points.
